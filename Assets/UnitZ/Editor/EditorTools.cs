...
public class EditorTools : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        source = (GameObject)EditorGUILayout.ObjectField("Source Transform", source, typeof(GameObject), true);
        target = (GameObject)EditorGUILayout.ObjectField("Target Transform", target, typeof(GameObject), true);
