    ...
    public void EnterGame(UnitZGameType type)
    {
        ...
        switch (StartType)
        {
            ...
            case UnitZGameType.Single:
                ...
                UnitZ.gameNetwork.AssignPlayersToSpawn(new PlayerLobby[1] { new PlayerLobby { CharacterIndex = UnitZ.characterManager.CharacterIndex, playerName = UnitZ.gameManager.UserName, playerTeam = 0, PlayerID = UnitZ.gameManager.UserID } });
                UnitZ.gameNetwork.HostGame(SceneStart, false);
